...
let timeValues = Array.from(transactions, o => o.time);
...
// Grab an element
var hr = document.getElementById('table'),
// Make a new div
    hrChild = document.createElement('td');

// Give the new div some content
hrChild.innerHTML = `${timeValues}`;

// Jug it into the parent element
hr.appendChild(hrChild);
